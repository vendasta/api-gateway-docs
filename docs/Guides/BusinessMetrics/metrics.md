...
This documentation provides Vendasta Partners and Vendors with the ability to send their data to our platform, where it will be used to generate cards for the Executive Report(both single and multi-location), in a way that supports slicing and rolling up reporting in any way that users need.
...
Implementation Details: Retrieve OAuth Bearer Token
...
Label
Provided automatically via aggregationKey
Statically set - please communicate desired string to the Vendasta team.
Short description of card(required)
Longer tooltip description if needed(optional)
...
Vendor Center DEMO Login: https://developers-vendasta-demo.appspot.com/login
Partner Center DEMO Login: https://partner-central-demo.appspot.com/login
